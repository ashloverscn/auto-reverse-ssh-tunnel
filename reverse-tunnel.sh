...
REMOTE_HOST=ash-temp-new-23129.portmap.host
...
autossh -4 -M 0 -o "PubkeyAuthentication=yes" -o "StrictHostKeyChecking=no" -o "PasswordAuthentication=no" -o "ServerAliveInterval=10" -o "ServerAliveCountMax=3" -N $PORT_STR -i $REMOTE_KEY -p $REMOTE_HOST_SSH_PORT $REMOTE_HOST_SSH_USER@$REMOTE_HOST
